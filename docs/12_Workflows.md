...
**Cross-references:** the applications these workflows belong to are documented screen-by-screen in [02_Office_App.md](02_Office_App.md), [03_Employee_App.md](03_Employee_App.md), and [04_Client_Portal.md](04_Client_Portal.md). The underlying conditional logic behind each workflow (exact thresholds, validation rules, why each rule exists) is catalogued separately in [13_Business_Rules.md](13_Business_Rules.md). The database tables referenced throughout are documented in full in [05_Database.md](05_Database.md).
...
*This document was produced by a full manual review of every relevant function in all three applications. No code was modified while producing it. Where a stage genuinely does not apply to a feature, this is stated explicitly rather than omitted, so nothing has been silently skipped. See [00_Project_Overview.md](00_Project_Overview.md) for the full documentation index.*
