...
// app's real behavior.
export function _portalVatRate(){ return portalVatRate(_S); }
...
export let _d=null;
export let _S={};
let _cs='expiry', _cd='asc', _certView='list', _wizardStep=1;
...
export function empty(icon,t,sub){return`<div class="empty"><i data-lucide="${icon}" style="width:48px;height:48px"></i><div class="et">${t}</div><div class="es">${sub}</div></div>`;}
...
export function attachDelegates(){
...
Object.assign(window, {
  ...
  previewCertPdf, setPropSearch, setPropSort, shareCert,
  shareCurrentPreviewCert, submitReq, toast,
