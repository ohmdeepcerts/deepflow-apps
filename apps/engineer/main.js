...
export function getUploadHD(){ return _uploadHD; }
  ...
  document.getElementById('modal-body').innerHTML=`
    ...
    <div class="d-section">
      ...
      <div class="ba-mode-toggle">
        <button class="ba-mode-btn ${getBaMode()?'':'active'}" onclick="_setPhotoMode(false,this)">📷 Standard</button>
        <button class="ba-mode-btn ${getBaMode()?'active':''}" onclick="_setPhotoMode(true,this)">🔄 Before / After</button>
      </div>
      <div id="ba-photo-area"></div>
      <div class="stamp-notice" id="stamp-notice-txt">📸 Photos auto-stamped with address${getBaMode()?', sequence &amp; Before/After label':' and your name'}.</div>
      <div class="upload-quality-row">
        <button class="quality-btn ${!getUploadHD()?'active':''}" onclick="setQuality(false,this)">📱 Compressed</button>
        <button class="quality-btn ${getUploadHD()?'active':''}" onclick="setQuality(true,this)">🔷 HD Original</button>
      </div>
      ...
      <div id="std-upload-btn" style="display:${getBaMode()?'none':'block'}">
        <div class="upload-zone" onclick="document.getElementById('photo-input').click()">
          ...
          <div class="upload-zone-sub">${getUploadHD()?'HD quality — full resolution':'Compressed — faster upload, smaller size'}</div>
        </div>
      </div>
    </div>
