...
export function initPlanner(){
  ...
  el('dfpProjectPickerBackdrop').addEventListener('click', e=>{ if(e.target===el('dfpProjectPickerBackdrop')) closeProjectPicker(); });
  el('dfpProjectPickerSearch').addEventListener('input', renderProjectPickerList);
